...
<div class="row mt-1">
    <div class="col-md-6">
        <input type="text" minlength="1" placeholder="Ingresar la Cantidad del Producto" name="cantidad" v-model="cantidad" class="form-control text-center"  :class="{'field-error': cantidad === '' && error}" autocomplete="off">
    </div>
    <div class="col-md-6">
        <div class="input-group mb-3">
            <span class="input-group-text">$</span>
                <input type="text" :readonly="disabledprecio" placeholder="Ingresar el Precio Unitario" name="precio_unitario" min="1" v-model="precio_unitario" class="form-control text-center"  :class="{'field-error': precio_unitario === ''  && error}" autocomplete="off" minlength="1" maxlength="4" step="0.01">
        </div>
    </div>
</div>
