        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 pt-2">
                <div class="card">
                    ...
                    <!-- Parte del inicio de sesión donde se ingresa el correo electrónico y la contraseña -->
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-7">
                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" minlenght="6" maxlength="12">
                            ...
                            <div class="row mb-3 form-group"> <!-- Botón de inicio de sesión -->
                                <div class="col-md-7 offset-md-3 row mb-3">
                                    <button type="submit" class="btn btn-primary text-center">
                                        {{ __('Iniciar Sesión') }}
                                    </button>
                                </div>
                                <div class="form-group col-md-6 offset-md-4"> <!-- Enlace para recuperar la contraseña -->
